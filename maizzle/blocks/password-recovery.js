export const passwordRecoveryMail = () => {
  return `
          ...
          <table class="bg-white w-600 sm:w-full">
            <tr class="">
              <td class="text-center pb-24 sm:pb-12">
                <h1 class="font-semibold text-black text-2xl">Parolanızı Sıfırlayın</h1>
              </td>
            </tr>
            <tr>
                ...
                <table class="w-3/4 sm:w-full">
                  <tr>
                    <td class="bg-white p-48 sm:px-24 text-center">
                      <p class="text-lg font-semibold m-0">Merhaba @{{page.name}},</p>
                      <p class="text-gray-700 text-base">Hesabınızın şifresini sıfırlamak için bu bağlantıyı tıklayın:</p>
                      ...
                      <a
                        ...
                        <!--[if mso]><i style="letter-spacing: 24px; mso-font-width: -100%; mso-text-raise: 26pt;">&nbsp;</i><![endif]-->
                          <span style="mso-text-raise: 13pt;">Parola Sıfırla &rarr;</span>
